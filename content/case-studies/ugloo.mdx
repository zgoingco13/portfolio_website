...
<ComparisonGrid labels={["What worked", "What was missing"]}>
  <div className="rounded-xl border border-border bg-card p-5">
    <p className="font-sans text-[11px] uppercase tracking-[2px] text-honey mb-2">Existing Tools</p>
  ...
  <div className="rounded-xl border border-border bg-card p-5">
    <p className="font-sans text-[11px] uppercase tracking-[2px] text-honey mb-2">Gaps Identified</p>
